...
if __name__ == '__main__':
    ...
    create_subscription("ada2025-450209", "diabetes_res", "diabetes_res_sub")
    pull_message(project="ada2025-450209", subscription="diabetes_res_sub")  # replace your project id
